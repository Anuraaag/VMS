...
<div class="container">
    <div class="row">
        <div class="col-md-4 col-md-offset-9" style="border-left: 1px solid black;">
           ...
           <div style="height:60px; text-align:center; color:blue; font-size:24px;" > Traffic Police Registration </div>

                <div>
                    <form class="form-horizontal" method="POST" action="{{ route('trafficpolice.register') }}">
                        {{ csrf_field() }}
